...
final mapOldNotifierProvider =
    NotifierProvider<MapOldLogicNotifier, MapPageState>(
        MapOldLogicNotifier.new);

class MapOldLogicNotifier extends Notifier<MapPageState> {
  @override
  build() {
    return MapPageState();
  }
